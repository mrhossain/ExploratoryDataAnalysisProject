...
#png(filenam ="C:\\Users\\Razib\\Desktop\\result\\plot2.png", width = 480, height = 480)
png(filenam ="plot2.png", width = 480, height = 480)
plot(subDate$Date2, subDate$Global_active_power, type = "l", ylab = "Global Active Power (kilowatts)", xlab="")
dev.off()
